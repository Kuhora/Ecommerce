...
const Navbar = () => {
    ...
    return (
        <header className='fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdropd-blur-md shadow-lg z-40 transition-all duration-300 border-b border-emerald-800'>
            <div className='container mx-auto px-4 py-3'>
                <div className="flex flex-wrap justify-between items-center">
                <Link to='/' className='text 2xl front-bold text-emerald-400 items-center space-x-2 flex'>
                    E-Commerce
                </Link>
