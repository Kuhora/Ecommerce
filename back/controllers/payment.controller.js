...
export const createCheckoutSession =  async (req, res) => {
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            paymement_method_types:["card",],
            line_items:lineItems,
            mode:"payment",
            sucess_url:`${process.env.CLIENT_URL}/purchase-sucess?session_id={CHECKOUT_SESSION_ID}`,
...
export const checkoutSucess = async(req,res) => {
    try {
        ...
        console.log("Error processing sucessful checkout:", error);
